...
| Lesson | Comments |
|---|---|
| [SQL](https://www.youtube.com/watch?v=7mz73uXD9DA&t=223s) | Instead of using Postgres (or any other database), just use [db-fiddle](https://www.db-fiddle.com/), no setup needed |
